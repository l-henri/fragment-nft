...
var fragmentClaimer = artifacts.require("./fragment-claimer/fragmentClaimer.sol");
...
async function doDeploy(deployer, network, accounts) {
    ...
    fragmentClaimerContract = await deployer.deploy(fragmentClaimer, 500, ERC721Contract.address);
